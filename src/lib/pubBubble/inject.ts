...
#az-pb-root,.az-pb-bubble,.az-pb-panel,#az-pb-root *,.az-pb-bubble *,.az-pb-panel *{box-sizing:border-box}
...
function setExpanded(v){expanded=v;if(panel)panel.hidden=!v;}
...
function onKey(e){if(e.key==='Escape'&&expanded)setExpanded(false);}
